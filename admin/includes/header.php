...
<head>
    ...
    <link href="/LexLink/admin/assets/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active" id="mydashboard">
                <a class="nav-link" href="/LexLink/admin/index.php">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapselawyers"
                    aria-expanded="true" aria-controls="collapselawyers">
                ...
                <div id="collapselawyers" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/LexLink/admin/lawyer/pending-requests.php">Pending Requests</a>
                        <a class="collapse-item" href="/LexLink/admin/lawyer/all-lawyers.php">All Lawyers</a>
                    </div>
                </div>
            </li>
