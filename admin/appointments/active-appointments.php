...
WHERE (appointment_status='pending' OR appointment_status='accepted') ";
                            ...
                            <tr>
                                ...
                                <td class="status <?php echo $active['appointment_status']; ?>">
                                    ...
                                    <?php if ($active['appointment_status'] == 'pending') : ?>
                                        ...
                                        <a href="active-appointments.php?acceptID=<?php echo $active['appointment_id']; ?>"
                                            class="btn btn-primary btn-sm swal-btn"

                                            data-action="Accept"
                                            data-href="active-appointments.php?acceptID=<?php echo $active['appointment_id']; ?>"
                                        ...
                                        <!-- Used by SweetAlert: data-action type & data-href link -->
                                        <a href="active-appointments.php?rejectID=<?php echo $active['appointment_id']; ?>"
                                            class="btn btn-danger btn-sm swal-btn"

                                            data-action="Reject" 
                                            data-href="active-appointments.php?rejectID=<?php echo $active['appointment_id']; ?>"> 
                                            Reject
                                        </a>
                                    ...
                                    <?php elseif ($active['appointment_status'] == 'accepted') : ?>
                                        ...
                                        <!-- Used by SweetAlert: data-action type & data-href link -->
                                        <a href="active-appointments.php?completeID=<?php echo $active['appointment_id']; ?>"
                                            class="btn btn-primary btn-sm swal-btn"

                                            
                                            data-action="Complete" 
                                            data-href="active-appointments.php?completeID=<?php echo $active['appointment_id']; ?>"
