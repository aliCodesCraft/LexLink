...
<head>
  ...
  <title>LexLink</title>
  <link rel="stylesheet" href="/LexLink/assets/user_assets/css/remixicon.css">
  <link rel="icon" href="/LexLink/assets/user_assets/images/Logos/logoWhite.png" type="image/x-icon">
  ...
  <link rel="stylesheet" href="/LexLink/assets/user_assets/css/style.css">
  <link rel="stylesheet" href="/LexLink/assets/user_assets/css/custom.css">
  <link rel="stylesheet" href="/LexLink/assets/user_assets/css/swiper-bundle.min.css">
  <link rel="stylesheet" href="/LexLink/assets/user_assets/css/responsive.css">
...
<body>
  ...
  <div class="header">
    <nav>
      <div class="logo">
        <a href="/LexLink/index.php"><img src="/LexLink/assets/user_assets/images/Logos/logoNavy.png" alt="" width="100px" height="100px"></a>
      </div>
            ...
            <div class="login-dropdown" id="loginDropdown">
              ...
              <?php if (isset($_SESSION['username']) && isset($_SESSION['role'])): ?>
                ...
                <?php elseif ($_SESSION['role'] === 'lawyer'): ?>
                  <a href="lawyer//LexLink/index.php">Dashboard</a>
